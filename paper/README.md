# ASP Whitepapers — Two-Document Track

> **Codex Hash Research Laboratory — Whitepaper Series · 2026**
> Author: Ulisses Flores · São Paulo, Brazil · https://ulissesflores.com

This directory holds two independent, cross-referencing documents.

## The two whitepapers

### Whitepaper 1 — Experience report on the system

**`asp-preprint.md`** — *ASP: An Operational Pre-Mortem Skill for LLM
Coding Agents — An Experience Report.*

A system-description / experience-report whitepaper. ~5,000 words. Documents
...
### Whitepaper 2 — Pre-registered protocol on the empirical finding

**`iron-law-11.md`** — *Graceful Refusals as Silent Successes: A
Pre-Registered Protocol for Characterising `claude -p` Exit-Code
Semantics.*

A focused tooling whitepaper, pre-registered before data collection.
...
observation made during Whitepaper 1's evaluation battery (the `claude -p`
...
| Whitepaper 1 references Whitepaper 2 | Whitepaper 2 references Whitepaper 1 |
|---|---|
| §1 contributions — the Iron Law 11 finding is reported in companion paper | §1 introduction — the observation arose during Whitepaper 1's evaluation battery |
...
## Why this two-whitepaper structure

A single 6,000-word document trying to be both a system description
...
Splitting solves both problems. Whitepaper 1 becomes an honest experience
report at appropriate length. Whitepaper 2 becomes a focused, independently
publishable tooling note that can be expanded with empirical data
when the run completes.

The pre-registration on Whitepaper 2 is what makes the split scientifically
